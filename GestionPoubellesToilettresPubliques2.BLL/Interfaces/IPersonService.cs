...
namespace GestionPoubellesToilettresPubliques2.BLL.Interfaces
{
    public interface IPersonService
    {
        ...
        Person? Update(int person_Id,
            string lastname, string firstname, string email, string address_Street, string address_Nbr, string postalCode, string address_City, string address_Country, string telephone, string gsm);
    }
}
